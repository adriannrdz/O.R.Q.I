...
def mainbot():
    while True:  
        ...
        prefijo1=st.selectbox("Valencia 3", (1,key = "fstprefix1",2,key = "fstprefix2",3,key = "fstprefix3",4,key = "fstprefix4",5,key = "fstprefix5",6,key = "fstprefix6",7,key = "fstprefix7",8,key = "fstprefix8",9,key = "fstprefix9"))
